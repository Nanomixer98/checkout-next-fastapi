...
export default function CheckoutPage() {
  ...
  const handleSubmit = async (data: CheckoutFormValues) => {
    ...
    try {
      ...
      router.push(`/confirmation?orderId=${result.orderId}&amount=${result.amount}&status=completed`)
    } catch (err) {
                ...
                <Tabs value={activeTab} onValueChange={handleTabChange} className="w-full">
                  ...
                  <TabsContent value="customer" className="mt-0">
                    ...
                    <div className="flex justify-end mt-6">
                      <Button type="button" onClick={() => handleTabChange("payment")} className="ml-auto">
                        Continue to Payment
                      </Button>
                    </div>
                  </TabsContent>
